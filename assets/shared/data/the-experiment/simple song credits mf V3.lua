composer = "Steampianist" -- This goes for each song, you have to adjust the names.
charter = "SillyPebblez, ZesCrew2, Brenninho" -- This goes for each song, you have to adjust the names.
artist = "SillyPebblez, ZesCrew2, amiamy111" -- This goes for each song, you have to adjust the names.
animator = "SillyPebblez, ZesCrew2" -- This goes for each song, you have to adjust the names.
va = "Vocaloid Gumi" -- This goes for each song, you have to adjust the names.
-- bpm = "145" -- Please make sure to change the bpms for each song, because I don't know how to get the chart bpms correctly. (way before Herox figured it out as I don't need that one)
---------------------------------------------------------------------------------------------
