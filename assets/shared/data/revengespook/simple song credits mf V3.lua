...
charter = "DISGRACED EX DEV thefungang123, ZesCrew2" -- This goes for each song, you have to adjust the names.
artist = "PhantomArcade, Maticss, Tom Shades, ZesCrew2, JAPPA, Notch" -- This goes for each song, you have to adjust the names.
animator = "PhantomArcade, Tom Shades" -- This goes for each song, you have to adjust the names.
va = "Sr. Pelo, Kawaii Sprite" -- This goes for each song, you have to adjust the names.
