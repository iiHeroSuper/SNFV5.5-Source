composer = "YOYLECAKE Michael" -- This goes for each song, you have to adjust the names.
charter = "ZesCrew2" -- This goes for each song, you have to adjust the names.
artist = "Anima52719" -- This goes for each song, you have to adjust the names.
animator = "Anima52719" -- This goes for each song, you have to adjust the names.
va = "Anima52719" -- This goes for each song, you have to adjust the names.
